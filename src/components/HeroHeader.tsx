...
export const HeroHeader: React.FC<HeroHeaderProps> = ({
  ...
  return (
    <header className="w-full bg-[#090d16] text-white border-b border-orange-500/20 relative overflow-hidden">
      ...
      <div className="w-full bg-gradient-to-r from-orange-600/25 via-amber-500/20 to-orange-600/25 border-b border-orange-500/30 px-4 py-1.5 text-xs text-orange-200 flex items-center justify-between">
        ...
        <button
          ...
          className="p-1 rounded-md text-orange-300/60 hover:text-white hover:bg-slate-800/80 transition-colors"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-7 sm:py-9">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-5 text-center lg:text-left">
            ...
            <div className="relative flex-shrink-0">
              <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl bg-gradient-to-br from-[#1a2030] to-[#0d1322] border border-orange-500/40 p-2 flex items-center justify-center shadow-xl shadow-orange-950/50 relative group">
                ...
                <img
                  ...
                  className="w-14 h-14 sm:w-16 sm:h-16 object-contain relative z-10 drop-shadow-[0_4px_12px_rgba(249,115,22,0.4)]"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold tracking-tight text-white flex items-center justify-center lg:justify-start gap-2">
              ...
              <div className="mt-3 p-3 rounded-xl bg-slate-900/90 border border-slate-800 text-xs text-slate-300 max-w-2xl text-left">
        ...
        {/* Clean Public Navigation Tabs Bar - ONLY Public Tabs (Form & QR) */}
        <div className="mt-7 flex flex-wrap items-center justify-between border-t border-slate-800/80 pt-4 gap-4">
